    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                 ...
                 * passport未登录
                 */
//                if (responseHeaders.containsKey("passport.login.flag")) {
////                    if (!UrlFilter.ignorCheck(request.getOriginUrl())) {
...
//                    Log.i("BasicNetwork", "RedirectUrl : " + newUrl);
...
//                }
                ...
                if (statusCode < 200 || statusCode > 299) {
                    ...
                    volleyError.setTag2(statusCode);
                    throw volleyError;
                }
